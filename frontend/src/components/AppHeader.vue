    ...
    <div class="util">
      <div class="container util-row">
        ...
        <div class="right">
          ...
          <span class="sep"></span>
          <router-link v-if="auth.isBuyer" :to="{ name: 'wishlist' }" class="icn">
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M19 14c1.5-1.5 3-3.3 3-5.5A4.5 4.5 0 0 0 12 6 4.5 4.5 0 0 0 2 8.5C2 13 12 21 12 21s4-3.2 7-7Z"/></svg>찜
          </router-link>
